...
function App() {
  const BASE_URL = "https://todos-backend.vercel.app/";
  ...
  return (
    <div className="min-h-screen bg-blue-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        <h1 className="text-2xl font-bold text-blue-800 mb-4">Todo App</h1>

        <form onSubmit={addTodo} className="flex mb-4">
          <input
            type="text"
            placeholder="Add a new task..."
            className="flex-grow px-4 py-2 border border-blue-400 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <button className="bg-purple-600 text-white px-4 py-2 rounded-r-lg hover:bg-blue-600 focus:outline-none">
            Add
          </button>
        </form>

        {!todos.length && (
          <span className="text-center flex justify-center text-gray-800">
            Todos is empty
          </span>
        )}
